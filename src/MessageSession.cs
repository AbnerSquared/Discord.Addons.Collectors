...
namespace Discord.Addons.Collectors
{
    ...
    public abstract class MessageSession
    {
        ...
        /// </summary>
        /// <returns>An <see cref="SessionResult"/> that determines what the <see cref="MessageCollector"/> should proceed with.</returns>
        public abstract Task<SessionResult> OnMessageReceivedAsync(SocketMessage message);
